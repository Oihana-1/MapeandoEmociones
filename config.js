    ...
    chapters: [
       {
        ...
        },
        {
            ...
            description: '<stronge> Aquí se apagan nuestras fuerzas, pero no por un cansancio cualquiera, sino por habernos entregado en cuerpo y alma a esta aventura. <br> Yacemos, no solo en quietud física, sino con el corazón abigarrado de haber descubierto lo más profundo de la esencia vasca. Hemos explorado los túneles del tiempo que aún subsisten, respirando historias y cultura, navegado por su mar y caminado por sus senderos. <br> En este instante, en que la energía se convierte en emoción, el corazón se impregna de huellas imborrables. <br> El cuerpo se rinde, pero el alma… el alma sigue latiendo con fuerza. <br> Gracias por acompañarme en este viaje tan auténtico como tú, que te has quedado conmigo hasta el final. En cada paso dado, algo de nosotros se quedó, y el entorno el recuerdo nos regaló. <br> Espero haberte acariciado el alma, como a mí me la han tocado estos lugares. Y hallas podido descubrir que si se puede mapear emociones, que no son solo puntos en el mapa.<br> Ahora sí, toca descansar. <br> ¡Hasta pronto!',
            location: {
                center: [-4.20503, 40.92106],
                zoom: 1.58,
                pitch: 0,
